...
export default function Login() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Si hay subdomain: usar /restaurantes/login
      const endpoint = !subdomain ? "/superadmin/login" : "/restaurantes/login";
      ...
      <form onSubmit={onSubmit}>
        <FieldGroup className="py-4">
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full text-white py-5 bg-primary hover:bg-primary/90"
            style={{
